...
//
//		WebElement displayCA = this.driver.findElement(By.cssSelector("#output #currentAddress"));
//		Assertions.assertEquals("Current Address :Ravenstone", displayCA.getText());
//
//		WebElement displayPA = this.driver.findElement(By.cssSelector("#output #permanentAddress"));
//		Assertions.assertEquals("Permananet Address :Leicestershire", displayPA.getText());
//	}
